...
from tllm.models.backend_mlx.parallel_layer import MergeParallelLayer, QKVParallelLayer, RowParallelLayer
...
class MergedAttention(nn.Module):
    def __init__(self, args, layer_idx: int, offset: int, qk_norm: bool = False):
        ...
        self.rope = initialize_rope(
            self.head_dim,
            getattr(args, "rope_theta", 10000),
            getattr(args, "rope_traditional", False),
