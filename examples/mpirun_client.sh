...
mpirun --verbose -hostfile mpi_hosts -wdir /Users/lujianghu/Documents/tLLM -np 2 -x DYLD_LIBRARY_PATH=/opt/homebrew/lib/ -x PYTHONPATH="/Users/lujianghu/Documents/tLLM":$PYTHONPATH /opt/homebrew/bin/python3 tllm/grpc/worker_service/worker_server.py --master_addr $MASTER_URL --is_debug
