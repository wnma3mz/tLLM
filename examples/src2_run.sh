...
CONFIG_PATH=./examples/src2_config.json
export OMP_NUM_THREADS=8;
PYTHONPATH="./src2:./src":$PYTHONPATH python3 src2/app.py --port 8000 --model_path $MODEL_PATH --weight_path $WEIGHT_PATH --config_path $CONFIG_PATH
